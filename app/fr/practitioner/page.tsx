      ...
      <section className="py-16 sm:py-24 bg-gray-50">
        <Container>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-5 max-w-7xl mx-auto">
            {[
              { name: 'NM Capture', desc: 'Photos avant/après standardisées' },
              { name: 'NM Consult', desc: 'Dossier patient intelligent' },
              { name: 'Copilot AI', desc: 'Assistant IA conversationnel' },
              { name: 'NM Revolution', desc: 'Vidéos dynamiques patients' },
              { name: 'NM Agenda', desc: 'Synchronisation Doctolib' }
            ].map((tool, index) => (
              <div
                key={index}
