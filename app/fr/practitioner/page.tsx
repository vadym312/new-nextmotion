        ...
        <Container>
          ...
          <div className="max-w-4xl mx-auto">
            <TestimonialsCarousel
              testimonials={[
                {
                  quote: "Nextmotion a rationalisé toute ma pratique. Les notes de consultation pilotées par IA m'économisent 2 heures par jour, et les patients adorent les simulations 3D.",
                  author: "Dr. Emma Wilson",
                  role: "Chirurgien Esthétique, Londres",
                  rating: 5,
                },
                {
                  quote: "La gestion des photos avant/après est exceptionnelle. Tout est organisé, standardisé et facile à partager. Mon marketing n'a jamais été aussi efficace.",
                  author: "Dr. Michael Chen",
                  role: "Médecin Cosmétique, Singapour",
                  rating: 5,
                },
                {
                  quote: "L'intégration avec mon workflow existant a été transparente. Le portail patient a considérablement amélioré l'engagement et la satisfaction.",
