        ...
        <Container>
          ...
          <div className="max-w-4xl mx-auto">
            <TestimonialsCarousel
              testimonials={[
                {
                  quote: "Les simulations 3D ont complètement changé notre manière de consulter. Les patients visualisent les résultats avant de s'engager, ce qui a considérablement augmenté notre taux de conversion.",
                  author: "Dr. Alexandre Moreau",
                  role: "Chirurgien Plasticien, Paris",
                  rating: 5,
                },
                {
                  quote: "Les patients sont éblouis par les aperçus 3D réalistes. Cela établit des attentes claires et réduit l'anxiété. Cet outil est essentiel pour une pratique esthétique moderne.",
                  author: "Dr. Isabelle Bernard",
                  role: "Médecin Esthétique, Monaco",
                  rating: 5,
                },
                {
                  quote: "La facilité d'utilisation et la précision scientifique de Nextmotion 3D sont impressionnantes. Mes patients se sentent plus confiants dans leurs décisions.",
                  author: "Dr. Thomas Garnier",
                  role: "Chirurgien Esthétique, Lyon",
                  rating: 5,
                },
              ]}
              autoPlay={true}
