        ...
        <Container>
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-600">
              Gérer une clinique implique de jongler avec de multiples responsabilités
            </p>
          </div>
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4 max-w-7xl mx-auto">
            {[
              { icon: Users, title: 'Coordination d\'équipe', desc: 'Gérer les horaires et responsabilités' },
              { icon: Calendar, title: 'Flux de rendez-vous', desc: 'Optimiser réservations et capacité' },
              { icon: FileText, title: 'Gestion des données', desc: 'Organiser les dossiers patients' },
              { icon: BarChart3, title: 'Insights business', desc: 'Comprendre les performances' },
            ].map((item, index) => {
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-b from-white to-gray-50">
        <Container>
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-600">
              Tout ce dont vous avez besoin pour gérer votre clinique efficacement
            </p>
          </div>
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 max-w-5xl mx-auto justify-items-center">
            {[
              { icon: BarChart3, title: 'Tableau de bord Analytics', desc: 'Insights en temps réel sur les performances' },
              { icon: Users, title: 'Gestion d\'équipe', desc: 'Coordonner horaires et rôles du personnel' },
              { icon: Calendar, title: 'Planification intelligente', desc: 'Optimiser rendez-vous et capacité' },
              { icon: FileText, title: 'Contrôle documentaire', desc: 'Dossiers patients centralisés' },
              { icon: TrendingUp, title: 'Outils de croissance', desc: 'Suivre et améliorer les indicateurs clés' },
            ].map((item, index) => {
              const Icon = item.icon;
              return (
                <div
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-b from-white to-gray-50">
        <Container>
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-600">
              Plateforme de gestion complète pour des opérations cliniques efficaces et des insights précis
            </p>
          </div>
        ...
        <Container>
          ...
          <div className="max-w-4xl mx-auto">
            <TestimonialsCarousel
              testimonials={[
                {
                  quote: "Le tableau de bord de gestion me donne des informations en temps réel sur chaque aspect de notre clinique. Je peux prendre des décisions éclairées instantanément.",
                  author: "Jessica Thompson",
                  role: "Manager de Clinique, Miami",
                  rating: 5,
                },
                {
                  quote: "La planification et coordination du personnel n'ont jamais été aussi faciles. Le système gère les conflits automatiquement et tient tout le monde informé.",
                  author: "David Martinez",
                  role: "Responsable Opérations, Los Angeles",
                  rating: 5,
                },
                {
                  quote: "Les outils de reporting sont complets mais faciles à utiliser. Je peux suivre les KPI, les revenus et la satisfaction des patients au même endroit.",
                  author: "Rachel Green",
