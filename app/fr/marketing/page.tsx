          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-start">
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#0F172A] mb-6 leading-tight">
                Développez votre cabinet esthétique avec un marketing
                intelligent
              </h1>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Convertissez plus de prospects, fidélisez plus de patients et
                mettez en valeur vos résultats avec des outils marketing
                puissants conçus pour les cliniques esthétiques.
              </p>
        ...
        <Container>
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-600">
              Se démarquer sur un marché concurrentiel et convertir plus de
              patients
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Attirer des patients potentiels qualifiés",
              },
              {
                icon: Share2,
                title: "Création de contenu",
                desc: "Créer du contenu avant/après engageant",
              },
              {
                icon: MessageSquare,
                title: "Engagement patient",
                desc: "Construire confiance et fidélité",
              },
              {
                icon: BarChart3,
                title: "Suivi ROI",
                desc: "Mesurer l'efficacité marketing",
              },
            ].map((item, index) => {
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-b from-white to-gray-50">
        <Container>
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-600">
              Tout ce dont vous avez besoin pour attirer et fidéliser plus de
              patients
            </p>
          </div>
            ...
            {[
              {
                icon: Sparkles,
                title: "NM Revolution",
                desc: "Créez automatiquement des vidéos avant/après dynamiques",
              },
              {
                icon: Share2,
                title: "Export réseaux sociaux",
                desc: "Partagez les résultats sur les plateformes sociales",
              },
              {
                icon: Users,
                title: "Recommandations patients",
                desc: "Transformez les patients satisfaits en ambassadeurs",
              },
              {
                icon: BarChart3,
                title: "Analytics",
                desc: "Suivez les performances des campagnes et le ROI",
              },
              {
                icon: MessageSquare,
                title: "Portail patient",
                desc: "Engagez les patients dans leur parcours",
              },
            ].map((item, index) => {
              const Icon = item.icon;
              return (
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-b from-white to-gray-50">
        <Container>
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-600">
              Plateforme marketing conçue pour mettre en valeur vos résultats et
          ...
          <div className="max-w-4xl mx-auto">
            <TestimonialsCarousel
              testimonials={[
                {
                  quote:
                    "Les outils marketing ont transformé notre façon d'attirer de nouveaux patients. Notre engagement sur les réseaux sociaux a triplé depuis que nous partageons les résultats avec Nextmotion.",
                ...
                {
                  quote:
                    "Le générateur de vidéos avant/après est phénoménal. Nous créons du contenu marketing professionnel en minutes, pas en heures. Notre taux de conversion n'a jamais été aussi élevé.",
                  author: "Kevin Brown",
                ...
                {
                  quote:
                    "Les recommandations patients ont augmenté de 40% depuis l'implémentation des fonctionnalités de partage automatisé. Les analyses nous aident à comprendre ce qui résonne avec notre audience.",
                  author: "Lisa Chen",
        ...
        <Container>
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-blue-100 mb-8 leading-relaxed">
              Rejoignez les cliniques esthétiques qui utilisent Nextmotion pour
              attirer plus de patients et développer leur cabinet
            </p>
